...
#align(center)[
  #text(size: 17pt, weight: "bold")[Phân tích Khám phá Dữ liệu & Kết quả Ban đầu] \
...
Hợp đồng tương lai vĩnh cửu (perpetual futures, viết tắt _perp_) là một công cụ phái sinh cho phép giao dịch có đòn bẩy trên giá của một tài sản (ví dụ BTC, SOL) mà *không có ngày đáo hạn*---khác với hợp đồng tương lai truyền thống. Vì không có ngày đáo hạn để giá hợp đồng tự động hội tụ về giá giao ngay (spot), cơ chế giữ cho giá perp bám sát giá spot là *tỷ lệ tài trợ* (funding rate): định kỳ (thường mỗi 1--8 giờ), bên nắm giữ vị thế mua (long) và bên nắm giữ vị thế bán (short) thanh toán một khoản phí nhỏ cho nhau, tỷ lệ thuận với chênh lệch giữa giá perp và giá chỉ số (index/oracle price). Khi giá perp cao hơn giá spot, long trả phí cho short (khuyến khích bán, kéo giá xuống); khi thấp hơn, chiều ngược lại. Perp hiện là công cụ phái sinh crypto phổ biến nhất và ngày càng đóng vai trò trung tâm trong việc khám phá giá (price discovery).

== Đòn bẩy, Ký quỹ và Cơ chế Thanh lý (Liquidation)

Một vị thế perp được mở bằng một khoản *ký quỹ ban đầu* (initial margin) $m$, nhân với *đòn bẩy* (leverage) $ell$ để có quy mô vị thế danh nghĩa $s = m times ell$ (ví dụ: ký quỹ 100 USD, đòn bẩy 10x ⟹ vị thế trị giá 1000 USD). Sàn/giao thức yêu cầu vị thế luôn duy trì một mức *ký quỹ duy trì* (maintenance margin) tối thiểu, tính theo tỷ lệ ký quỹ hiện tại trên quy mô vị thế. Khi giá thị trường di chuyển ngược hướng vị thế đủ để tỷ lệ ký quỹ giảm xuống dưới ngưỡng duy trì, vị thế đó chạm *giá thanh lý* (liquidation price)---xấp xỉ
$ P_"liq" approx P_"entry" times (1 minus.plus 1/ell) quad ("Long: " -,quad "Short: " +), $
và bị *đóng cưỡng bức* (force-closed): sàn/giao thức (hoặc một _keeper_/liquidator bên thứ ba được thưởng phí) tự động đóng vị thế bằng cách khớp một lệnh ngược chiều ra thị trường, bất kể chủ vị thế có đồng ý hay không. Đòn bẩy càng cao, khoảng cách tới giá thanh lý càng hẹp---đây chính là biến định lượng cốt lõi của các đặc trưng "đông đúc" (crowding) trong báo cáo (mức đòn bẩy trung bình, mức tập trung vị thế theo tầng ví).

== Cơ chế gây ra Đợt Bùng phát Thanh lý (Liquidation Cascade)

Rủi ro hệ thống đặc trưng của perp là *thác thanh lý* (liquidation cascade): việc đóng cưỡng bức một vị thế long tạo ra một lệnh _bán_ ra thị trường; việc đóng một vị thế short tạo ra một lệnh _mua_. Nếu nhiều vị thế cùng chiều tập trung quanh một vùng giá thanh lý gần nhau (positioning "đông đúc" và một chiều), việc thanh lý loạt vị thế đầu tiên đẩy giá đi xa hơn theo đúng hướng đã gây thanh lý, kích hoạt lớp vị thế đòn bẩy tiếp theo chạm ngưỡng thanh lý của chính nó---một chuỗi phản ứng *tự kích thích, lây lan* (self-exciting, contagious). Đây chính là cơ chế mà quá trình Hawkes (@eq:intensity, số hạng thứ hai) mô hình hóa: mỗi sự kiện thanh lý làm tăng tạm thời xác suất xảy ra sự kiện thanh lý tiếp theo. Câu hỏi trung tâm của luận văn là liệu _trạng thái đông đúc hiện tại của thị trường_ (crowding state, số hạng $mu_k (x_k (t))$ trong @eq:intensity)---chứ không chỉ lịch sử sự kiện gần đây---có mang thông tin dự báo được đợt bùng phát _tương lai_ hay không.
...
== Vì sao Dự báo Đợt Bùng phát Thanh lý

Hợp đồng tương lai vĩnh cửu là công cụ phái sinh crypto phổ biến nhất và ngày càng là nơi khám phá giá chính. Rủi ro hệ thống đặc trưng của chúng là _thác thanh lý_: khi một cụm vị thế đòn bẩy vi phạm ngưỡng ký quỹ duy trì, các lệnh thanh lý cưỡng bức bán ra thị trường, đẩy giá đi xa hơn, và kích hoạt lớp vị thế đòn bẩy tiếp theo---một chuỗi tháo chạy tự kích thích, lây lan. Các tín hiệu cảnh báo sớm hiện có mà giới thực hành sử dụng (tỷ lệ tài trợ cực đoan, mất cân bằng long/short, open interest kỷ lục) là các ngưỡng heuristic, không phải mô hình dự báo đã hiệu chỉnh. Luận văn này đặt một câu hỏi sắc bén hơn, có thể học được: _cho trạng thái thị trường tại thời điểm $t$, xác suất xảy ra một đợt bùng phát thanh lý đồng bộ trong $h$ phút tiếp theo là bao nhiêu, và các đặc trưng đông đúc phân giải theo tầng ví có cải thiện dự báo đó so với một mô hình nền thuần túy tự kích thích hay không?_

== Định nghĩa Hình thức của Đợt Bùng phát

Gọi $L_(a,t)$ là số sự kiện thanh lý của tài sản $a$ trong khung 5 phút $t$ (nguồn: `close_action = Liquidate`). Nhãn bùng phát tại tầm dự báo $h$ (tính theo số khung) và ngưỡng $theta$ là
...
$ lambda_k (t) = underbrace(mu_k (x_k (t)), "hàm nền điều kiện hóa theo đông đúc") + sum_(k') sum_(t_j < t) alpha_(k'->k) phi(t - t_j) $ <eq:intensity>
trong đó $phi$ là hạt nhân kích hoạt dạng mũ (exponential triggering kernel), $alpha_(k'->k)$ là ma trận kích thích chéo-mark (lây lan chéo-tầng, chéo-sàn), và $x_k (t)$ là véc-tơ các hiệp biến _đông đúc theo tầng ví_. Số hạng thứ hai là tự kích thích Hawkes cổ điển của @bacry2015hawkes; thành phần mới là hàm nền điều kiện hóa theo đông đúc $mu_k (dot)$. Giả thuyết trung tâm của luận văn là $x_k (t)$ mang thông tin về các đợt bùng phát _tương lai_ vượt ra ngoài những gì lịch sử sự kiện gần đây có thể cung cấp. @fig:intensity ánh xạ mỗi họ mô hình vào hai số hạng của @eq:intensity.
...
== Bài toán Đánh giá (và Tương phản với Wallet Skill)

Một công thức trước đây trên cùng cơ sở dữ liệu---chấm điểm kỹ năng ví theo chiều giao dịch (side-aware wallet skill scoring)---thất bại vì lý do đo lường: nhãn đánh giá của nó (tỷ lệ thắng tương lai trên một số ít giao dịch) gần như 99% là nhiễu lấy mẫu nhị thức, nên không phương pháp nào có thể chứng minh vượt trội hơn các mô hình nền đơn giản. Công thức hiện tại được lựa chọn có chủ đích để tránh cái bẫy đó. Nhãn bùng phát @eq:burst là một _đếm sự kiện_ trên một luồng dữ liệu dày đặc (190.573 lượt thanh lý), không phải một tỷ lệ nhiễu theo từng ví. @sec:m0burst cho thấy nhãn này có khả năng học mạnh. Hệ quả là mục tiêu mô hình hóa không còn là "liệu bùng phát có dự đoán được không" (câu trả lời gần như hiển nhiên là có, nhờ tự tương quan thời gian) mà là _đặc trưng đông đúc cải thiện dự báo thêm bao nhiêu so với mô hình nền tự kích thích_---một câu hỏi được đặt ra rõ ràng, đo lường được.

== Đóng góp

Tóm gọn trong một câu: _hiệp biến đông đúc, khi được tiêm vào hàm nền cường độ của một quá trình tự kích thích, gần như tăng gấp đôi PR-AUC so với các mô hình nền quá trình điểm chỉ dựa vào cường độ, trên một dự báo bùng phát thanh lý ngoài mẫu, an toàn không rò rỉ._ Cụ thể:
...
*G3 --- Lây lan xuyên giao thức mới chỉ được mô tả, chưa được dự báo.* @cao2025defi thiết lập cụm lây lan xuyên giao thức theo hướng mô tả; chưa công trình nào biến lan tỏa liên tài sản thành một dự báo _cảnh báo sớm_ có hiệu chỉnh, an toàn không rò rỉ, cho đợt bùng phát tiếp theo.
...
*G5 --- Đánh giá dưới mất cân bằng cực đoan bị xử lý sai.* Tỷ lệ dương 0,56% khiến ROC-AUC gây hiểu lầm; độ đo trung thực là precision-recall---một kỷ luật đánh giá vắng mặt trong các báo cáo thác thanh lý trước đây.
...
#figure(
  ...
  caption: [Pipeline đầu-cuối. `logs` thô được tái tạo thành vị thế đã đóng, sau đó bộ xây dựng bảng (panel builder) tạo ra một dòng an toàn không rò rỉ cho mỗi (tài sản, khung 5 phút) trên một lưới thời gian toàn cục đồng bộ: đặc trưng lấy từ $[t-w,t]$, nhãn lấy từ cửa sổ tương lai rời rạc $(t,t+h]$. Bảng được chia theo thời gian và mọi mô hình được chấm điểm trên cùng các khung kiểm tra.]
) <fig:pipeline>
...
*Quá trình Hawkes (mô hình nền tự kích thích).* Một quá trình Hawkes đơn biến mô hình hóa cường độ điều kiện của các sự kiện thanh lý dưới dạng một tỷ lệ nền hằng số $mu$ cộng tổng các kích thích suy giảm do mỗi sự kiện quá khứ đóng góp: $lambda(t) = mu + sum_(t_j<t) alpha e^(-beta(t-t_j))$. Mỗi sự kiện nâng cường độ lên ngay lập tức một lượng $alpha$, sau đó suy giảm theo hàm mũ với tốc độ $beta$ về lại $mu$; khi nhiều sự kiện xảy ra gần nhau, các mức kích thích cộng dồn khiến cường độ tăng vọt hẳn lên trên nền trước khi hạ nhiệt---đây chính xác là hình ảnh của một thác thanh lý ở cấp độ đếm sự kiện. @fig:hawkesexample mô phỏng một quá trình ổn định (dưới ngưỡng tới hạn), tỷ lệ phân nhánh $alpha/beta approx 0,61 < 1$, và vẽ đường cường độ cùng với các thời điểm sự kiện mô phỏng: giai đoạn yên tĩnh nằm ở mức $mu$, và mỗi sự kiện tạo ra một bước nhảy rõ rệt rồi suy giảm, với một cụm ba sự kiện gần nhau đẩy $lambda(t)$ lên gần gấp 5 lần mức nền trước khi hạ nhiệt. Luận văn khớp mô hình này riêng cho từng tài sản bằng hợp lý cực đại và dùng chính $lambda(t)$ đã khớp làm điểm số bùng phát; mô hình nền *Hawkes có thành phần thị trường* bổ sung một số hạng kích thích thứ hai, điều khiển bởi các sự kiện thanh lý toàn thị trường (mọi tài sản) với tốc độ suy giảm riêng---một xấp xỉ khả thi cho lây lan xuyên sàn mà không cần đầy đủ ma trận hạt nhân đa biến.
...
#figure(
  table(
    ...
    table.header([Tài sản], [Số vị thế], [Spearman($w$, lợi suất kỳ hạn)], [$p$ (Pearson)]),
...
#figure(
  table(
    ...
    table.header([$h$ (phút)], [$theta$], [Tỷ lệ nền gộp], [Số dương], [AUC(15ph trước → bùng phát)]),
...
#figure(
  table(
    ...
    table.cell(colspan: 4, align: left)[_Mô hình nền quá trình điểm đã công bố (chỉ thời điểm sự kiện)_],
    ...
    table.cell(colspan: 4, align: left)[_Mô hình dùng hiệp biến (luận văn này)_],
    [LGBM nền (cường độ trễ, 2 đặc trưng)], [phân biệt], [0,9078], [0,2281],
    [LGBM đầy đủ (+đông đúc+khối lượng+liên tài sản, đã chỉnh)], [phân biệt], [*0,9801*], [0,2502],
...
#figure(
  image("../pipeline/outputs/b01_burst_baseline/burst_baseline_lift.png", width: 92%),
